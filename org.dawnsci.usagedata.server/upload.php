...
/*
 * This function answers true if the User-Agent field in the HTTP Header indicates that the source of the information is an Eclipse instance running the UDC. It answers false otherwise.
 */
...
require_once ($_SERVER ['DOCUMENT_ROOT'] . '/UploadManager.php');
